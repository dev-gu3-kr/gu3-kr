...
type BulletinListViewProps = {
  queryInput: string
  status: BulletinPublishFilterDto
  ...
  onStatusChange: (value: BulletinPublishFilterDto) => void
  onLoadMore: () => Promise<void>
}

export function BulletinListView({
  queryInput,
  status,
  items,
  isLoading,
