...
export const homePageMock: HomePageViewModel = {
  ...
  quickLinks: [
    ...
    {
      label: "미사와 성사",
      href: "/notice/mass-times",
      icon: HomeQuickMassSacramentsSvg,
    },
    {
      label: "오시는 길",
      href: "/parish/directions",
  ...
  massTimes: [
    {
      ...
      drawerGroups: [
        {
          label: "오전",
          lines: ["6시 30분(새벽), 10시 30분(교중)"],
        },
        {
          label: "오후",
          lines: ["12시(중고등부), 3시(유초등부), 6시(청년부), 9시(밤)"],
        },
        {
          label: "토요일",
          lines: ["오후 7시(토요주일)"],
    ...
    },
    {
      ...
      drawerGroups: [
        {
          label: "월/화/수/금",
          lines: ["오전 6시 30분, 오후7시"],
        },
        {
          label: "목요일",
          lines: ["오전 6시 30분, 오전 10시, 오후 7시"],
        },
        {
          label: "토요일",
          lines: ["오전 6시 30분"],
