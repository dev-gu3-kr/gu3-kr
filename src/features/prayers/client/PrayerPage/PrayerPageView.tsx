      ...
      >
        {props.tabs.map((tab) => (
          <Button
            ...
            variant="outline"
            className={cn(
              "min-h-10 rounded-full px-4 py-1.5 text-[14px] font-semibold shadow-none transition-all duration-150 hover:-translate-y-px hover:shadow-[0_8px_20px_rgba(37,38,41,0.08)] focus-visible:ring-[#e85a5e]/30 md:min-h-[48px] md:px-6 md:py-2.5 md:text-[15px]",
